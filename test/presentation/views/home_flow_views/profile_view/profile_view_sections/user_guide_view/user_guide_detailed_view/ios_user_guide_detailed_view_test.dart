...
Future<void> main() async {
  await prepareTest();
  late IOSUserGuideEnum testDataSource;

  setUp(() async {
    await setupTest();
    testDataSource = IOSUserGuideEnum.step1;
  ...
  group("UserGuideDetailedView Widget Tests", () {
    ...
    testWidgets("previous step tap widget structure",
        (WidgetTester tester) async {
      final IOSUserGuideEnum dataSource = IOSUserGuideEnum.step2;
    ...
    testWidgets("handles different data source types",
        (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step5;
    ...
    testWidgets("handles edge case data sources", (WidgetTester tester) async {
      IOSUserGuideEnum lastStep = IOSUserGuideEnum.step18;
    ...
    testWidgets("cover step3", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step3;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step4", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step4;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step6", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step6;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step7", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step7;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step8", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step8;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step9", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step9;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step10", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step10;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step11", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step11;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step12", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step12;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step13", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step13;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step14", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step14;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step15", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step15;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step16", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step16;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
    ...
    testWidgets("cover step17", (WidgetTester tester) async {
      final IOSUserGuideEnum androidSource = IOSUserGuideEnum.step17;
      await tester.pumpWidget(
        createTestableWidget(
          UserGuideDetailedView(userGuideViewDataSource: androidSource),
        ),
