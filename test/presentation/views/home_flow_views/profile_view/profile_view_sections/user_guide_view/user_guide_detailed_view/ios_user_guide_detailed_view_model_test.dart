...
Future<void> main() async {
  ...
  group("UserGuideDetailedViewModel Tests", () {
    ...
    test("onViewModelReady sets isFromAndroidScreen false", () {
      final IOSUserGuideEnum androidDataSource = IOSUserGuideEnum.step1;
      final UserGuideDetailedViewModel androidViewModel =
          UserGuideDetailedViewModel()
            ..userGuideViewDataSource = androidDataSource
            ..onViewModelReady();

      expect(androidViewModel.isFromAndroidScreen, isFalse);
    ...
    test("data source updates correctly for next step", () async {
      viewModel.userGuideViewDataSource = IOSUserGuideEnum.step1;
      final UserGuideViewDataSource nextSource =
          viewModel.userGuideViewDataSource.nextStepTapped();

      expect(nextSource, equals(IOSUserGuideEnum.step2));
    });

    test("data source updates correctly for previous step", () {
      viewModel.userGuideViewDataSource = IOSUserGuideEnum.step2;
      final UserGuideViewDataSource nextSource =
          viewModel.userGuideViewDataSource.previousStepTapped();

      expect(nextSource, equals(IOSUserGuideEnum.step1));
    });
    ...
    test("previousStepTapped method updates data source", () {
      ...
      expect(previousStep, equals(IOSUserGuideEnum.step1));
    });
    ...
    test("data source stays at last step when at end", () {
      viewModel.userGuideViewDataSource = IOSUserGuideEnum.step18;
      final UserGuideViewDataSource nextSource =
          viewModel.userGuideViewDataSource.nextStepTapped();

      expect(nextSource, equals(IOSUserGuideEnum.step18));
    });
    ...
    test("data source stays at first step when at beginning", () {
      ...
      expect(previousSource, equals(IOSUserGuideEnum.step1));
    });
    ...
    test("handles different Android steps correctly", () {
      final List<IOSUserGuideEnum> steps = <IOSUserGuideEnum>[
        IOSUserGuideEnum.step1,
        IOSUserGuideEnum.step5,
        IOSUserGuideEnum.step10,
        IOSUserGuideEnum.step15,
        IOSUserGuideEnum.step18,
      ];

      for (final IOSUserGuideEnum step in steps) {
    ...
    test("scrollController state is maintained", () {
      ...
      viewModel.userGuideViewDataSource = IOSUserGuideEnum.step5;
    ...
    test("data source type checking works", () {
      expect(viewModel.userGuideViewDataSource, isA<IOSUserGuideEnum>());
